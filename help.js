...
<:download:910474079931338813> No total de **146** Comandos.
...
'`Ship|Cafune|Beijar|Casar|Abraço|Atacar|Futebol|Jokempo|Dados|Brindar|Stonks|8ball|Coinflip|Adestramento|Faustão|Cantadas|Traficaranao|Bolsonaro|Corno|Gay|Audio|Falar`', true) 
...
'`Mineração | Implorar | Crime \n Caso queira comprar use o suporte! G!suporte`', true) 
...
msg.edit({embeds: [embed_1]})
        ...
        msg.edit({embeds: [embed_1]})
                ...
                '`Atm|Saldo|Depositar|Sacar|Pay|Rank`', true) 
   ...
   '`Avatar|Playstore|Clear|Lembrete|Ms|Say|Userinfo|Serverinfo|Infobot|Status|Uptime|Bigtext|Gerarsenha|Cpu|Emoji|Banner|Anuncio|Calculadora|Traduzir|Addemoji|Google|`', true)
msg.edit({embeds: [embed_1]})
	...
	.addField('⚒️ Comandos Moderação:',  
            '`Ban | Unban | Unbanall | Voicekick | Lock | Unlock | Setnick | Addcargo | Removecargo | Lockall | Unlockall | Roleinfo | Banlist |`', true) 
